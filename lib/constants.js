...
${contextBlock}Analyze high-intent variations and long-tail opportunities based strictly on achievable positioning.
For each of the 10 keywords, strictly use this EXACT format block:
**Target Keyword:** [your keyword here]
**Search Intent:** [Problem-Aware, etc.]
**Position Potential:** [High/Med/Low]
**Difficulty Score:** [1-100]

Provide 10 highly-accurate keywords in a continuous numbered list (1, 2, 3... to 10). Do not reset the number for each item. No emojis.`;
};
