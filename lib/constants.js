...
Then provide:
- A beautifully formatted table (do NOT use "##" for this table's heading, instead use "📊 **Competitor Overview Matrix**"): Columns: Competitor | Top Topics | Content Format | SEO Strategy | Strength
